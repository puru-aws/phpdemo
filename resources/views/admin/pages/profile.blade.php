...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
            <a href="#ac_password" aria-controls="ac_password" role="tab" data-toggle="tab">{{trans('words.password')}}</a>
        </li>        
        </li>
    </ul>
        ...
        <div role="tabpanel" class="tab-pane active" id="account">             
            {!! Form::open(array('url' => 'admin/profile','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="instagram" value="{{ Auth::user()->instagram }}" class="form-control" value="">
                    </div>
                </div>
				<div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{trans('words.save_changes')}} <i class="md md-lock-open"></i></button>
